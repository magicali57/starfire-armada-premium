...
| Fleet | Ship roster, ship details, acquisition, leveling, Star Rank, intrinsic weapon upgrades, abilities, skins, ship comparison and companion screens |
| Inventory | Active loadout, modules, materials, entry items, consumables and cosmetics inventory |
...
**Compatibility note:** Companion screens are visually owned by Fleet and keep Fleet active in the permanent navigation. Their existing internal `#/inventory/companions...` paths are retained for compatibility and do not indicate Inventory ownership.
...
## 14. Inventory, loadout and historically numbered companion screens
...
> **Approved ownership correction:** The following companion screens retain their historical `I-04`–`I-06` identifiers only to avoid renumbering this document. Their current visual and global-navigation owner is Fleet. Companions Roster, Companion Detail and Companion Upgrade keep Fleet active, while their existing internal `/inventory/companions` route paths remain unchanged for compatibility.
...
- I-04 through I-06 Fleet-owned companion screens (historical identifiers; existing internal routes retained)
- I-02/I-03 and I-07 through I-11 Loadout, modules and materials
...
7. Ship Acquisition
8. Companions Roster
9. Companion Detail/Upgrade

### Group 4 — Inventory and loadout

1. Loadout Manager
2. Modules Inventory
3. Module Detail/Upgrade
4. Materials
